...
urlpatterns = [
    ...
    # urls.py - Add these to your urlpatterns
...
path('attendance/upload-photo/', views.attendance_upload_photo, name='attendance_upload_photo'),
